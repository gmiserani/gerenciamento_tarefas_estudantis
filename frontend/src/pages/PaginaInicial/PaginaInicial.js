      ...
      <Grid container component="main" sx={{ height: '100vh' }}>
        ...
        <Grid item xs={12} sm={8} md={5} component={Paper} elevation={6} square>
          ...
          >
            ...
            Plataforma para a organização de tarefas escolares e universitárias. Acesse seu perfil e adicione suas provas, trabalhos e atividades avaliativas para ter o controle de prazos de entrega, pontuações e muito mais!
            </Typography>
            <Typography component="h1" variant="h7">
